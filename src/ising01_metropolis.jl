...
#Montecarlo code for ising spin s_i = 0,1
...
@compat function do_mcmc_ising_01(J::Array{Float64,2},
...
###### DO MONTECARLO ###############
function mc_ising_01(filename::AbstractString,
			     beta::Union{Float64,Int64}=1.0,
			     N_term::Union{Float64,Int64}=10e5,
			     N_sweep::Union{Float64,Int64}=10e4,
			     dec::Union{Float64,Int64}=10e2)

	@printf("%s\n", "Montecarlo-metropolis for ising spin 0,1")
	...
	S=do_mcmc_ising_01(J,beta,N_term,N_sweep,dec)
